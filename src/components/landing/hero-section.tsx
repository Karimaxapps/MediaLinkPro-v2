...
function useSequenceTypewriter(
  sequences: ReadonlyArray<{ subject: string; find: string }>,
  speed = 65,
  pause = 1800
) {
  ...
  useEffect(() => {
    ...
    if (!deleting && charIdx < fullStr.length) {
      ...
      setDeleting(false);
      setSeqIdx((i) => (i + 1) % seqCount);
    }

    return () => clearTimeout(timer);
    // sequences is memoized with [] in the parent so identity is stable
      ...
      >
            ...
            <div className="space-y-2">
              {[
                ...
                },
                {
                  ...
                  sub: "Ross Video · Director",
                  color: "#00FFFF",
                },
                {
                  icon: Shield,
                  label: "Vendor verified",
                  sub: "Harmonic StreamBuilder",
                  color: "#22c55e",
                },
              ].map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <div className="text-[9px] font-semibold text-white leading-none truncate">
                        {item.label}
                      </div>
        ...
        >
          ...
          <div className="text-[9px] text-gray-400 mb-3 leading-relaxed">
            4K Live encoding · Ultra-low latency · Cloud-ready
          </div>
        ...
        >
          ...
          <motion.circle
            ...
            style={
              { offsetPath: "path('M 30 30 C 100 30, 188 190, 258 190')" } as React.CSSProperties
            }
...
export function HeroSection() {
  ...
  const sequences = useMemo(
    () => [
      { subject: t("seq0Subject"), find: t("seq0Find") },
  ...
  return (
    <section className="relative bg-[#0B0B0B] overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent, transparent 2px, #00FFFF 2px, #00FFFF 3px)",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 pt-16 pb-12 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[calc(100vh-80px)]">
        ...
        >
          ...
          >
            <span className="text-white block">{t("networkTitle")}</span>
            <span className="text-gray-400 text-3xl md:text-4xl xl:text-5xl font-semibold">
              {t("where")}{" "}
            </span>
