        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-400">
                    {t.rich("companyManageDesc", { org: () => <span className="text-[var(--brand)] font-medium">{primaryOrg.name}</span> })}
                </p>
            </div>
            <Separator className="bg-white/10" />
            ...
            <div className="p-6 bg-white/5 rounded-xl border border-white/10 space-y-6">
                <div className="flex items-center gap-4">
                    <div className="h-16 w-16 rounded-lg bg-white/10 flex items-center justify-center">
                        <Building className="h-8 w-8 text-[var(--brand)]" />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-white/5 rounded-lg border border-white/10">
                    ...
                    <code className="text-[10px] bg-black/50 p-1 rounded text-[var(--brand)]">
