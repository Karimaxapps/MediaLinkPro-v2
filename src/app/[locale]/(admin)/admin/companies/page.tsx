  ...
  return (
    <div className="space-y-6">
      <Link
        ...
        className="flex items-center justify-between rounded-xl border border-[#C6A85E]/40 bg-[#C6A85E]/10 p-4 hover:bg-[#C6A85E]/15 transition-colors"
      >
        <div className="flex items-center gap-3">
          <div className="rounded-lg bg-[#C6A85E]/20 p-2 text-[#C6A85E]">
